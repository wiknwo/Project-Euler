 ...
 * line have been marked in red. The product of these 
...
int main(){
    ...
    int greatest_product_four_adjacent_numbers_same_direction = -1;
    int product = 0;

    for(int i = 0;i < 20;i++){
        for(int j = 0;j < 20;j++){
            // Right
            if(i < 20 && j + 1 < 20 && j + 2 < 20 && j + 3 < 20){
            ...
            // Diagonal right
            if(i + 1 < 20 && j + 1 < 20 && i + 2 < 20 && j + 2 < 20 && i + 3 < 20 && j + 3 < 20){
        ...
        cout << greatest_product_four_adjacent_numbers_same_direction;
    }
}